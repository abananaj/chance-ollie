 ...
 * @version    Git: $Id: 23ca530d4c3b2f9ef5e9fbacd7100ac804bb67ea $
...
/**
 * Roots activation options page capability.
 * @return string
 */
...
/**
 * Roots theme activation options add page.
 * @return void
 */
function roots_theme_activation_options_add_page()
{
    $activation_options = roots_get_theme_activation_options();
...
/**
 * Roots get theme activation options.
 * @return string
 */
...
/**
 * Roots theme activation options render page
 * @return void
 */
                ...
                <tr valign="top"><th scope="row"><?php _e('Change uploads folder?', 'roots'); ?></th>
                    <td>
                        <fieldset><legend class="screen-reader-text"><span><?php _e('Update uploads folder?', 'roots'); ?></span></legend>
                            ...
                            <br>
                            <small class="description"><?php printf(__('Change uploads folder to example.com/media/ instead of example.com/wp-content/uploads/', 'roots')); ?></small>
                        </fieldset>
                    </td>
                </tr>
...
function roots_theme_activation_action()
{
    ...
    if ($activation_options['create_front_page'] === 'true') {
        $activation_options['create_front_page'] = false;
    ...
    if ($activation_options['change_permalink_structure'] === 'true') {
        $activation_options['change_permalink_structure'] = false;
    ...
    if ($activation_options['change_uploads_folder'] === 'true') {
        $activation_options['change_uploads_folder'] = false;
    ...
    if ($activation_options['create_navigation_menus'] === 'true') {
        $activation_options['create_navigation_menus'] = false;
        ...
        if (!$primary_nav) {
            $primary_nav_id = wp_create_nav_menu('Primary Navigation', ['slug' => 'primary_navigation']);
    ...
    if ($activation_options['add_pages_to_primary_navigation'] === 'true') {
        $activation_options['add_pages_to_primary_navigation'] = false;
    ...
    update_option('roots_theme_activation_options', $activation_options);
}
